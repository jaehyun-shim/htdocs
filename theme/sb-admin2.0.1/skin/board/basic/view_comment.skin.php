	...
	<article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
        ...
        <div class="cm_wrap">
            ...
            <header style="z-index:<?php echo $cmt_sv; ?>">
	            ...
	            <?php if ($is_ip_view) { ?>
	            <span class="text-xs">(<?php echo $list[$i]['ip']; ?>)</span>
	            <?php } ?>
	            <span class="bo_vc_hdinfo text-xs"><i class="fa fa-clock-o" aria-hidden="true"></i> <time datetime="<?php echo date('Y-m-d\TH:i:s+09:00', strtotime($list[$i]['wr_datetime'])) ?>"><?php echo $list[$i]['wr_datetime'] ?></time></span>
	            <?php
		...
		<div class="bo_vl_opt">
        	...
        	<ul class="bo_vc_act">
                <?php if ($list[$i]['is_reply']) { ?><li><a class="text-xs" href="<?php echo $c_reply_href; ?>" onclick="comment_box('<?php echo $comment_id ?>', 'c'); return false;">답변</a></li><?php } ?>
                <?php if ($list[$i]['is_edit']) { ?><li><a class="text-xs" href="<?php echo $c_edit_href; ?>" onclick="comment_box('<?php echo $comment_id ?>', 'cu'); return false;">수정</a></li><?php } ?>
                <?php if ($list[$i]['is_del']) { ?><li><a class="text-xs" href="<?php echo $list[$i]['del_link']; ?>" onclick="return comment_delete();">삭제</a></li><?php } ?>
            </ul>
        </div>
        <script>
			$(function() {			    
